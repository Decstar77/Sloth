...
namespace sloth
{
    ...
    public:
        ...
        FixedString& operator=(const char* str) { this->Assign(str); return *this; }
        FixedString& operator=(StringView view) { this->Assign(view); return *this; }
        FixedString& operator=(const FixedString& other) { this->Assign(other.CStr(), other.Length()); return *this; }
