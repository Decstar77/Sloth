...
namespace sloth {
    ...
    class Geometry {
      public:
        ...
        static MeshData CreatePlane( f32 width, f32 depth, u32 widthSegments = 1, u32 depthSegments = 1, const glm::vec3& color = glm::vec3( 1.0f ) );
        ...
        static MeshData CreateUVSphere( f32 radius, u32 latitudeSegments = 16, u32 longitudeSegments = 32, const glm::vec3& color = glm::vec3( 1.0f ) );
        ...
        static MeshData CreateCylinder( f32 radius, f32 height, u32 radialSegments = 16, const glm::vec3& color = glm::vec3( 1.0f ) );
    };
