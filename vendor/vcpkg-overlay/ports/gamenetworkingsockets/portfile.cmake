...
if("${VCPKG_LIBRARY_LINKAGE}" STREQUAL "dynamic")
    ...
    # Sloth patch: upstream's CMakeLists only skips PROTOBUF_USE_DLLS (which
    # bakes dllimport calls to protobuf into GNS's compiled objects) when
    # Protobuf_USE_STATIC_LIBS is set. The stock port never sets it, so a
    # "static" build here still requires a DLL protobuf to link against -
    # which doesn't exist when protobuf was also built statically. Force it
    # on whenever we're building GNS statically.
